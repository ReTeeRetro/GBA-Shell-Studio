      ...
      <div className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed space-y-4">
        ...
        <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
          ...
          <a 
            ...
            className="inline-flex items-center text-slate-900 dark:text-white underline decoration-slate-300 hover:decoration-slate-900 font-medium transition-colors group"
          >
